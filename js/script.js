...
const WISH_MESSAGES = [
	...
	"Chúc anh em năm mới bình an, hạnh phúc ❤️",
	"Sức khỏe dồi dào, tiền vào như nước 💪💰",
	"Công việc thuận lợi, làm đâu thắng đó 🚀",
	"Gia đình ấm êm, ngập tràn tiếng cười 😊",
	"Mọi điều ước đều thành hiện thực 🎯",
	"May mắn cả năm, niềm vui mỗi ngày 🎉",
	"Ra đường gặp quý nhân, về nhà có yêu thương 🏡",
	"Thành công nối tiếp thành công 🔥",
	"Một năm mới bùng nổ và rực rỡ ✨",
	"Năm mới phát tài phát lộc 💰",
	"Tiền vô ào ào, cơ hội tới tấp 🚀",
	"Làm ăn khấm khá, ký hợp đồng mỏi tay ✍️",
	"Sức khỏe dẻo dai, tinh thần luôn sung 💪",
	"Mọi việc hanh thông, thuận buồm xuôi gió 🌊",
	];
